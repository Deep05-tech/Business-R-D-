...
6. PRODUCT MATCHING: The user requested competitors based on exact products. Set 'manufactures_exact_same_products' to true if they manufacture AT LEAST ONE EXACT SPECIFIC PRODUCT from the target business's catalog (e.g. 'Torque Rod Arms'). If they do not explicitly list the exact product in the snippet, but they clearly manufacture HIGHLY RELATED products in the EXACT SAME NICHE CATEGORY, you MUST also set it to true. Only set it to false if they are in a completely unrelated or overly generic industry.
